...
import background1 from '../../images/pic4.jpg'
import { MDBRow, MDBContainer, MDBCol } from 'mdbreact'

function OtherCandidateMainPage(){
    return(
        <div style={{backgroundImage : `url(${background1})`,backgroundSize:'cover',backgroundPosition:'center',backgroundRepeat:"no-repeat",width:'100%',height:'100vh'}}>
        <br /><br /><br />
        <MDBContainer>
        <MDBRow>
            <MDBCol md="12">
        <h2 className="display-4 font-weight-bold text-center" style={{color:'white'}}>Welcome to Other Candidate Page</h2>
            </MDBCol>
...
export default OtherCandidateMainPage