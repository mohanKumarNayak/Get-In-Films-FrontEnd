...
import { startAddCandidatesToDirector} from '../../actions/directorAction'
import { startAddMovieToCandidate} from '../../actions/candidateAction'
import Swal from 'sweetalert2'
 
class AuditionMovieInfo extends React.Component{
    constructor(props){
        super(props)
        this.state = {
            show : false
    ...
    handleApplyAudition = () => {
        const candidateDetails = {
            candidate : this.props.candidate._id,
            name : this.props.candidate.fullname,
            age : this.props.candidate.age,
            email : this.props.candidate.email,
            mobile : this.props.candidate.mobile,
        ...
        Swal.fire({
            ...
            confirmButtonText: 'Yes, Apply!'
              ...
              if(result.value){
                this.props.dispatch(startAddCandidatesToDirector({id:id,candidateDetails}))
                this.props.dispatch(startAddMovieToCandidate({movieDetails}))
              }
          })
            ...
            <div className="container">
                ...
                <div className="row">
                    <div className="col-md-7">
                        ...
                        {
                            this.props.candidate && this.props.candidate.movieApplied &&  this.props.candidate.movieApplied.map(movie=>{return movie.movieName}).includes(this.props.newMovie.newMovie.movieName) ? <h2 className="display-4" style={{fontSize : "35px",fontWeight:"400"}}>Audition Applied</h2> : <button className="btn btn-primary" onClick={this.handleApplyAudition}>apply for audition</button>
                        }
...
export default withRouter(connect(mapStateToProps)(AuditionMovieInfo))