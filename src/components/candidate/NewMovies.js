...
import {startAddNewMovies,startAddAllDirectorInfo} from '../../actions/candidateAction'
...
class NewMovies extends React.Component{
    ...
    render(){
        if(this.props.newMovies.length == 0){
            this.props.dispatch(startAddNewMovies())
            this.props.dispatch(startAddAllDirectorInfo())
        }
        return(
            <MDBContainer>
                <br /><br /><br />
                                ...
                                return (
                                    ...
                                    <MDBRow>
                                        ...
                                        <MDBCol md="4" style={{border:"1px solid black"}}>
                                            ...
                                            <Link to={`/candidate/castingCalls/${movie.id}`} className="btn btn-primary btn-block" style={{borderRadius:"60px"}}>info</Link>
                                        </MDBCol>
                                    </MDBRow>
                                    <br />
                                    </div>
